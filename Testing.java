public class Testing
{
    ...
    Airfare plane = new Airfare(200,"Jet","Paris");
		System.out.println("Amount for plane: "+plane.getAmount()); //should return 200
    System.out.println("Description for plane: "+plane.getDescription());
    Meal brekkie = new Breakfast("IHOP",5);
    System.out.println("Number of meals at IHOP: "+brekkie.getNumberOfMeals());
    System.out.println("Amount spent at IHOP: "+brekkie.getAmount()); //should return 57.5
    Meal lunch1 = new Lunch("Dons",2);
    System.out.println("Number of meals at Dons: "+lunch1.getNumberOfMeals());
    System.out.println("Amount spent at Dons: "+lunch1.getAmount()); //should return 22.6
    Meal din1 = new Dinner("Fancy Shit",4);
    System.out.println("Number of meals at Fancy Shit: "+din1.getNumberOfMeals());
